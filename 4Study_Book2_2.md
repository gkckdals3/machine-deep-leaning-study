{
 "cells": [
  ...
  },
  {
   ...
   "source": [
    "print(test_target) # target값이 적절한 비율로 섞여있지 않으므로 샘플링 편향이 나타난다."
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    "train_scaled=(train_input-mean)/std #넘파이는 똑똑하게도 train_input의 모든 행에서 mean값을 뺴준다\n",
    "print(train_scaled) # 이러한 넘파이의 기능을 브로드캐스팅이라고 한다."
   ]
  },
  {
   "cell_type": "raw",
  ...
  },
  {
   ...
   "source": [
    "new=(([25,150]-mean)/std)\n",
    "distances,indexes=kn.kneighbors([new])#knn k=5인 근접한 5개의 인덱스"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [
    {
     "data": {
      "image/png": "\n",
      "text/plain": [
       "<Figure size 432x288 with 1 Axes>"
      ]
     },
